defmodule BoatNoodleWeb.MenuCatalogController do
  ...
  def list_menu_catalog_combo(conn, %{"brand" => brand, "subcatid" => subcat_id}) do
   ...
   def remove_from_catalog_combo(conn, %{
    ...
    combo_items = cata.combo_items |> String.split(",") |> Enum.sort() |> Enum.reject(fn x -> x == "" end)
  ...
  def insert_into_catalog_combo(conn, %{"brand" => brand,"subcat_id" => subcat_id,"tag_id" => catalog_id}) do
