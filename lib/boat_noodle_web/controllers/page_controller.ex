...
require IEx
  ...
  def index(conn, _params) do
    ...
    left_join: s in BoatNoodle.BN.Sales,on: sp.salesid==s.salesid, where: s.branchid== "1" and s.salesdate == ^date,select: %{gst_charge: sp.gst_charge,grand_total: sp.grand_total,salesid: s.salesid})
