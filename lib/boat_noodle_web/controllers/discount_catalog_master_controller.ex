defmodule BoatNoodleWeb.DiscountCatalogMasterController do
  ...
  def edit(conn, %{"id" => id}) do
    ...
    render(conn, "edit.html", discount_catalog_master: discount_catalog_master, changeset: changeset)
  end

  def update(conn, %{"id" => id, "discount_catalog_master" => discount_catalog_master_params}) do
    discount_catalog_master = BN.get_discount_catalog_master!(id)

    case BN.update_discount_catalog_master(discount_catalog_master, discount_catalog_master_params) do
      {:ok, discount_catalog_master} ->
        conn
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: discount_catalog_master_path(conn, :index))
  end
end
