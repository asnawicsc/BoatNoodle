    ...
    categories =
      Repo.all(
        from(
          c in ComboDetails,
          where: c.combo_id == ^id,
          left_join: b in ItemSubcat,
          where: c.combo_item_code == b.itemcode,
          left_join: d in ItemCat,
          where: b.itemcatid == d.itemcatid,
          group_by: d.itemcatid,
          select: %{
            itemcatname: d.itemcatname,
            itemcatid: d.itemcatid,
            itemcatcode: d.itemcatcode
          }
        )
      )
    ...
    ala_carte =
      Repo.all(
        from(
          ...
          where: c.combo_item_code != g.itemcode,
          left_join: d in ItemCat,
          where: d.itemcatid == g.itemcatid,
          select: %{
            itemcatcode: d.itemcatcode,
            itemcatid: d.itemcatid,
            itemcatname: d.itemcatname
