defmodule BoatNoodleWeb.SalesController do
  ...
  def detail_invoice(conn, %{"branchid" => branchid, "invoiceno" => invoiceno}) do
    ...
    gstpercentage =
     (Decimal.to_float(detail.gst_charge) / Decimal.to_float(detail.after_disc)) * 100
    ...
    detail = %{
      ...
      gstpercentage:
        gstpercentage|>Float.round(0) |> Float.to_string() |> String.reverse() |> String.split_at(2) |> elem(1)
        |> String.reverse(),
      servicepercentage:
        servicepercentage
        |>Float.round(0)
  ...
  defp discount_item_report_csv_content(conn, params) do
    ...
    end_date = params["end_date"]
     ...
     discount_item_report_csv_content =if branch_id != "0" do
  ...
  defp discount_item_detail_report_csv_content(conn, params) do
    ...
    end_date = params["end_date"]
      ...
      discount_item_detail_report_csv =if branch_id != "0"  do
