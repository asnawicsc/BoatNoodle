...
@primary_key false
  ...
  def changeset(branch, attrs) do
    branch
    |> cast(attrs, [:created_at,:updated_at,:payment_catalog,:version,:combo_catalog,:tag_catalog,:disc_catalog,:menu_catalog,:remain_sync,:sync_status,:receipt_text,:currency_symbol,:currency,:qb_dep2acc,:qb_custref,:branchid, :branchname, :branchcode, :b_phoneno, :b_address, :org_id, :tax_percent, :service_charge, :manager, :num_staff, :report_class])
