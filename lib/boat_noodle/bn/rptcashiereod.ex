...
@primary_key false
  ...
  def changeset(rptcashiereod, attrs) do
    rptcashiereod
    |> cast(attrs, [:rptid, :branch_id, :staff_name, :time_start, :time_end, :duration, :open_amt, :close_amt, :totalpax, :totalsales, :voidsales, :voiditem, :totaltax, :totalsvc, :total_round, :dinein, :takeaway, :total_disc, :total_pymt, :total_cash, :total_changes, :floats, :deposit, :cash_in, :paidout, :cash, :drawamt, :exp_drw_amt, :total_sr, :extra, :branchcode])
  end
end
