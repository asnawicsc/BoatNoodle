...
defmodule AddBrand4 do
  ...
  def change do
    ...
    execute(
      "ALTER TABLE `paymenttype` DROP PRIMARY KEY, ADD PRIMARY KEY (`payment_type_id`, `brand_id`);"
    )

    execute(
      "ALTER TABLE `staff_log_session` DROP PRIMARY KEY, ADD PRIMARY KEY (`log_id`, `brand_id`);"
    )
